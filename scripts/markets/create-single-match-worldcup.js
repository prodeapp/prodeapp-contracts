...
const marketData = {
  ...
  questions: [
    ...
    buildQuestionSingleSelect(`Will ${teams[0]} receive more yellow cards than ${teams[1]} at ${marketName}?`, yesNoDraw, openingTs + 8, 'soccer'),
    buildQuestionSingleSelect(`Will ${teams[0]} receive at least one red card at ${marketName}?`, yesNo, openingTs + 9, 'soccer'),
    buildQuestionSingleSelect(`Will ${teams[1]} receive at least one red card at ${marketName}?`, yesNo, openingTs + 10, 'soccer'),
